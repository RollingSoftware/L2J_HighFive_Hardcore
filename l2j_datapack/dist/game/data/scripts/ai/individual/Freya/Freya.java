...
public final class Freya extends AbstractNpcAI {
    ...
    private static final Location EXIT_LOCATION = new Location(115451, -125706, -3448);
    ...
    private void resetState() {
        ...
        if (state.supp_Jinia != null) {
            state.supp_Jinia.decayMe();
        }

        if (state.supp_Kegor != null) {
    ...
    private void teleportPlayersOut() {
        zone.getPlayersInside().forEach(player -> teleportPlayer(player, EXIT_LOCATION, 0, true));
    }
